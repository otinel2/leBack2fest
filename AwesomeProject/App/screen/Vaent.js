...
// export default function Vaent() {

const Vaent = ({navigation}) => {
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <Image source={require('../../assets/vaent.png')} style={styles.image} />
        <Text style={styles.title}>Vaent</Text>
      </View>
