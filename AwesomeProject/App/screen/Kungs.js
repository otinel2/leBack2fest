...
// export default function Kungs() {

const Kungs = ({navigation}) => {
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <Image source={require('../../assets/kungs.jpg')} style={styles.image} />
        <Text style={styles.title}>Kungs</Text>
      </View>
